...
TRAIN_SPLIT = "train"
BASELINE_PATH = STANZA_BASELINE / 'stanza_train_baseline_all.csv'
CORRECTED_PATH = STANZA_CORRECTED / 'stanza_train_corrected_v2_all.csv'
OUTPUT_PATH = OUTPUTS_METRICS / 'train_correction_v2_metrics.csv'
