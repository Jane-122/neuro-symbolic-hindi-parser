"""
Apply correction layer v2 to the Stanza dev baseline output.
"""
...
INPUT_PATH = STANZA_BASELINE / 'stanza_dev_baseline_all.csv'
OUTPUT_PATH = STANZA_CORRECTED / 'stanza_dev_corrected_v2_all.csv'
...
def main():
    ...
    print(f"Saved corrected dev baseline to: {OUTPUT_PATH}")
