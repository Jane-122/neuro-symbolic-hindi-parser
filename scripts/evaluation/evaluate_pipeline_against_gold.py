...
GOLD_PATH = OUTPUTS_GOLD / 'gold_karaka_labels.csv'
GOLD_UD_PIPELINE_PATH = STANZA_GOLD_UD / 'dev_baseline_all.csv'
STANZA_PIPELINE_PATH = STANZA_BASELINE / 'stanza_dev_baseline_all.csv'

GOLD_UD_EVAL_PATH = OUTPUTS_METRICS / 'gold_ud_vs_gold_karaka_eval.csv'
STANZA_EVAL_PATH = OUTPUTS_METRICS / 'stanza_vs_gold_karaka_eval.csv'
GOLD_UD_CONFUSION_PATH = OUTPUTS_METRICS / 'karaka_confusion_matrix_gold_ud.csv'
STANZA_CONFUSION_PATH = OUTPUTS_METRICS / 'karaka_confusion_matrix_stanza.csv'
