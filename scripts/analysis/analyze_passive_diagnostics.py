...
PIPELINE_PATH = STANZA_CORRECTED / 'stanza_dev_corrected_v2_all.csv'
SUMMARY_PATH = OUTPUTS_ERROR_ANALYSIS / 'passive_diagnostic_summary.csv'
EXAMPLES_PATH = OUTPUTS_ERROR_ANALYSIS / 'passive_diagnostic_examples.csv'
