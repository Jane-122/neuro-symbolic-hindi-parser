...
INPUT_PATH = Path("output/dev_neural_only_errors.csv")
ACTIONABLE_ERRORS_PATH = Path("output/dev_actionable_neural_errors.csv")
SUMMARY_PATH = Path("output/dev_actionable_error_summary.csv")
