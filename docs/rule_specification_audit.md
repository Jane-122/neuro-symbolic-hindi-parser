...
**Audited document:** `docs/rule_specification_v1.md`  
...
All **numeric percentages** cited in `docs/rule_specification_v1.md` are **correct** and traceable to `notebooks/02_postposition_analysis.ipynb` (Cells 5, 11, 13, 15) with denominator = all `case` tokens of that postposition form in `hi_hdtb-ud-train.conllu`.
...
- Rule specification: `docs/rule_specification_v1.md`
- Postposition analysis: `notebooks/02_postposition_analysis.ipynb`
- Mapping hypotheses: `docs/ud_to_karaka_mapping_v1.md`
