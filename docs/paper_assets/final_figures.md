...
| **Data source** | `docs/project_status_checkpoint_3.md`, `src/pipeline/`, pipeline CSV column definitions |
...
| **Data source** | `docs/project_status_checkpoint_3.md`, `output/aligned_ud_hdtb_sentences.csv`, `output/gold_karaka_labels.csv` |
...
| **Data source** | `docs/paper_assets/final_results_tables.md` (Table 4) |
...
| **Data source** | `docs/final_train_dev_results.md`, `docs/final_test_results.md`, `docs/paper_assets/final_results_tables.md` (Table 5) |
...
| **Data source** | `docs/correction_layer_log.md`, `docs/project_status_checkpoint_3.md`, `output/dependency_repair_v1_dev_eval.csv` |
...
| **Data source** | `docs/final_test_results.md`, Table 7 in `final_results_tables.md` |
...
| **Data source** | `docs/correction_layer_log.md`, dev actionable error summaries |
...
| **Data source** | `docs/passive_example_manual_summary.md`, `output/passive_diagnostic_summary.csv` |
...
|-------|---------|--------|----------|
| **T1: Dataset statistics** | UD sentences per split, HDTB sentences, gold Karaka row counts | `docs/project_status_checkpoint_3.md` | Essential |
| **T2: Alignment statistics** | Exact match and high-confidence match rates by split | `docs/project_status_checkpoint_3.md`, `output/aligned_ud_hdtb_sentences.csv` | Essential |
| **T3: Overall results** | Train/dev/test accuracy and macro F1 for all three systems | `docs/paper_assets/final_results_tables.md` Tables 1-3 | Essential |
...
| **T5: Per-Karaka F1** | Candidate and strict F1 by Karaka (test primary; dev/train supplementary) | `docs/final_test_results.md`, train/dev docs | Essential |
| **T6: H1 Adhikarana impact** | F1 gains and fire counts across splits | `final_results_tables.md` Table 5 | Essential |
| **T7: Token matching audit** | Matched/unmatched gold rows, match percentage | `docs/final_test_results.md` | Essential |
| **T8: Negative result (DR1)** | Deprel accuracy before/after DR1, repair outcome breakdown | `docs/correction_layer_log.md`, `output/dependency_repair_v1_dev_eval.csv` | Essential |
| **T9: Absolute improvements (test)** | Verifier and correction gains on held-out test | `docs/final_test_results.md` | Recommended |
| **T10: Gold label mapping** | HDTB Paninian label to Karaka mapping | `docs/project_status_checkpoint_3.md` | Optional |
