...
The report uses generated artifacts from `output/`, `results/`, `src/`, and `scripts/`. It deliberately includes negative results and failed hypotheses. Test split results are not reported as final evaluation because test is being kept frozen.
