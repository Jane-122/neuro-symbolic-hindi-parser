...
`docs/ud_to_karaka_mapping.md`

- Purpose: older non-versioned placeholder.
- Status: placeholder, superseded by `docs/ud_to_karaka_mapping_v1.md`.
...
- Purpose: audits the statistics cited in `docs/rule_specification_v1.md`.
- Evidence source: `notebooks/02_postposition_analysis.ipynb`.
- Status: active.

`docs/verifier_output_observations_v1.md`

- Purpose: manual inspection notes for verifier-only batch outputs.
- Input: `results/verifier_batch_meaningful.csv`.
- Status: active.

`docs/verifier_failure_analysis_v1.md`

- Purpose: failure-mode analysis for verifier-only meaningful outputs.
- Input: `notebooks/06_verifier_failure_analysis.ipynb`.
- Status: active.

`docs/verifier_v1_dev_baseline.md`

- Purpose: documents full gold UD dev baseline for Pipeline v1.
- Input outputs: `results/dev_baseline_all.csv`, `results/dev_baseline_meaningful.csv`.
- Status: active.
...
- Inputs: `results/verifier_batch_meaningful.csv`, `results/verifier_batch_all.csv`.
- Status: complete.
...
- Input: `results/gold_ud_pipeline_meaningful.csv`.
- Status: complete.

`notebooks/09_dev_baseline_analysis.ipynb`

- Purpose: analyzes full gold UD dev baseline.
- Inputs: `results/dev_baseline_all.csv`, `results/dev_baseline_meaningful.csv`.
- Status: complete.

`notebooks/10_stanza_vs_gold_analysis.ipynb`

- Purpose: compares gold UD dev baseline with Stanza dev baseline.
- Inputs: `results/dev_baseline_all.csv`, `results/dev_baseline_meaningful.csv`, `results/stanza_dev_baseline_all.csv`, `results/stanza_dev_baseline_meaningful.csv`.
- Outputs: matched rows and disagreement CSV files.
- Status: complete.

`notebooks/11_rule_disagreement_analysis.ipynb`

- Purpose: detailed analysis of verifier rule trigger differences between gold UD and Stanza outputs.
- Inputs: `results/stanza_vs_gold_rule_disagreements.csv`, `results/stanza_vs_gold_matched.csv`.
...
- Output: `results/run_on_sentence_output.txt`
- Status: helper and smoke test.

`src/verifier/run_verifier_batch.py`

- Purpose: runs verifier v1 on first 50 train sentences.
- Outputs: `results/verifier_batch_all.csv`, `results/verifier_batch_meaningful.csv`
...
- Outputs: `results/gold_ud_pipeline_all.csv`, `results/gold_ud_pipeline_meaningful.csv`
- Status: active.

`src/pipeline/run_dev_baseline.py`

- Purpose: combined mapper plus verifier pipeline on full gold UD dev split.
- Outputs: `results/dev_baseline_all.csv`, `results/dev_baseline_meaningful.csv`
- Status: active.
...
- Outputs: `results/stanza_pipeline_sample_all.csv`, `results/stanza_pipeline_sample_meaningful.csv`
- Status: active.
...
- Outputs: `results/stanza_dev_baseline_all.csv`, `results/stanza_dev_baseline_meaningful.csv`
- Status: active.
...
- Outputs: `results/dev_baseline_all.csv`, `results/dev_baseline_meaningful.csv`
- Report: `docs/verifier_v1_dev_baseline.md`
...
- `results/stanza_dev_baseline_all.csv`
- `results/stanza_dev_baseline_meaningful.csv`
...
`results/stanza_pipeline_sample_all.csv`

- Meaning: Pipeline v1 output for five fixed sample sentences parsed by Stanza.

`results/stanza_pipeline_sample_meaningful.csv`
...
`results/run_on_sentence_output.txt`
...
- Input: `results/stanza_vs_gold_final_decision_disagreements.csv`
...
- Outputs: `results/test_baseline_all.csv`, `results/test_baseline_meaningful.csv`
...
- Outputs: `results/stanza_test_baseline_all.csv`, `results/stanza_test_baseline_meaningful.csv`
...
- Update `docs/rule_specification_v1.md` header to reflect that verifier v1 is implemented.
- Expand `docs/research_notes.md` with current findings.
...
10. `notebooks/10_stanza_vs_gold_analysis.ipynb`
11. `notebooks/11_rule_disagreement_analysis.ipynb`
