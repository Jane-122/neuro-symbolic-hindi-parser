...
- `experiments/stanza/gold_ud/dev_baseline_all.csv` (35,217 rows)
- `experiments/stanza/gold_ud/dev_baseline_meaningful.csv` (7,019 rows)

**Analysis notebook:** `notebooks/analysis/09_dev_baseline_analysis.ipynb`
