...
**Source:** `notebooks/analysis/05_verifier_output_analysis.ipynb`  
**Input data:** `experiments/stanza/gold_ud/verifier_batch_meaningful.csv` (from `src/verifier/run_verifier_batch.py`)  
**Rule reference:** `docs/methodology/rule_specification_v1.md` (unchanged)

This document summarizes what the v1 verifier produced on a small batch. It records observations only. **No verifier rule logic is being changed yet**, and `docs/methodology/rule_specification_v1.md` is not updated here.
...
- Update `docs/methodology/rule_specification_v1.md`
...
Analysis notebook: `notebooks/analysis/05_verifier_output_analysis.ipynb`
