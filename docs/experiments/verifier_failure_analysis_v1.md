...
**Source notebook:** `notebooks/analysis/06_verifier_failure_analysis.ipynb`  
**Input data:** `experiments/stanza/gold_ud/verifier_batch_meaningful.csv` (36 rows), `experiments/stanza/gold_ud/verifier_batch_all.csv` (779 rows)  
...
**No changes made to:** `src/verifier/`, mapper, Stanza, HTDB, or `docs/methodology/rule_specification_v1.md`.
...
Re-run analysis: `notebooks/analysis/06_verifier_failure_analysis.ipynb`
