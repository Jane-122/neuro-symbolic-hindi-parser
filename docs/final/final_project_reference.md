...
| Document | Role |
|----------|------|
| `docs/final/final_train_dev_results.md` | Final train/dev metrics |
| `docs/final/final_test_results.md` | Final held-out test metrics |
| `docs/final/correction_layer_log.md` | Correction and DR1 decisions |
| `docs/archive/project_status_checkpoint_3.md` | Comprehensive status snapshot before test |
| `docs/paper/paper_assets/` | Paper planning tables and figure specs |
...
The internship began with a neuro-symbolic NLP goal: combine neural dependency parsing with Paninian grammar for Hindi. Early documents (`docs/methodology/project_context.md`, `docs/methodology/project_scope.md`) framed the work as building a **verifier and corrector over UD parses**, not merely a lookup table from UD labels to Karakas.
...
| Type | Path |
|------|------|
| Notebook | `notebooks/exploration/01_dataset_exploration.ipynb` |
| Notebook | `notebooks/exploration/02_postposition_analysis.ipynb` |
| Notebook | `notebooks/exploration/03_dev_postposition_comparison.ipynb` |
| Doc | `docs/methodology/project_context.md` |
| Doc | `docs/methodology/ud_to_karaka_mapping_v1.md` |
| Doc | `docs/methodology/rule_specification_v1.md` |
| Doc | `docs/methodology/rule_specification_audit.md` |
...
| Doc | `docs/methodology/rule_specification_v1.md` |
| Doc | `docs/experiments/verifier_output_observations_v1.md` |
| Doc | `docs/experiments/verifier_failure_analysis_v1.md` |
| Notebook | `notebooks/analysis/05_verifier_output_analysis.ipynb` |
| Notebook | `notebooks/analysis/06_verifier_failure_analysis.ipynb` |
| Notebook | `notebooks/analysis/07_pipeline_analysis.ipynb` |
| Output | `experiments/stanza/gold_ud/verifier_batch_all.csv` |
| Output | `experiments/stanza/gold_ud/verifier_batch_meaningful.csv` |
| Output | `experiments/stanza/gold_ud/gold_ud_pipeline_all.csv` |
...
| Output | `experiments/stanza/baseline/stanza_pipeline_sample_all.csv` |
| Output | `experiments/stanza/baseline/stanza_dev_baseline_all.csv` |
| Output | `experiments/stanza/baseline/stanza_train_baseline_all.csv` |
| Output | `experiments/stanza/baseline/stanza_test_baseline_all.csv` |
...
| Notebook | `notebooks/analysis/10_stanza_vs_gold_analysis.ipynb` |
| Doc | `docs/experiments/verifier_v1_dev_baseline.md` |
| Output | `experiments/stanza/gold_ud/dev_baseline_all.csv` |
| Output | `experiments/stanza/baseline/stanza_dev_baseline_all.csv` |
| Output | `experiments/stanza/comparisons/stanza_vs_gold_matched.csv` |
| Output | `experiments/stanza/comparisons/stanza_vs_gold_deprel_disagreements.csv` |
| Output | `experiments/stanza/comparisons/stanza_vs_gold_case_marker_disagreements.csv` |
| Output | `experiments/stanza/comparisons/stanza_vs_gold_final_decision_disagreements.csv` |
...
| Type | Path |
|------|------|
| Notebook | `notebooks/analysis/11_rule_disagreement_analysis.ipynb` |
| Output | `experiments/stanza/comparisons/stanza_vs_gold_rule_disagreements.csv` |
| Output | `experiments/stanza/comparisons/rule_disagreement_summary.csv` |
...
- Inspected file structure with `scripts/data_prep/inspect_hdtb_structure.py`.
- Confirmed columns include token, head, and Paninian relation label.
- Counted relation frequencies with `scripts/data_prep/count_hdtb_relations.py`.

**Important files:**

| Type | Path |
|------|------|
| Script | `scripts/data_prep/inspect_hdtb_structure.py` |
| Script | `scripts/data_prep/count_hdtb_relations.py` |
| Data | `data/raw/news_articles_and_heritage/` |
| Output | `outputs/gold/hdtb_relation_counts.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/data_prep/alignment_audit.py` |
| Script | `scripts/data_prep/alignment_audit_v2.py` |
| Script | `scripts/data_prep/build_aligned_hdtb_ud.py` |
| Script | `scripts/data_prep/inspect_unmatched_alignment.py` |
| Output | `outputs/alignment/aligned_ud_hdtb_sentences.csv` |
| Output | `outputs/alignment/unmatched_nearest_candidates.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/data_prep/extract_gold_karaka_labels.py` |
| Output | `outputs/gold/gold_karaka_labels.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/analysis/audit_dev_token_matching.py` |
| Script | `scripts/evaluation/evaluate_pipeline_against_gold.py` (shared matching utilities) |
| Output | `outputs/error_analysis/dev_token_matching_audit.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/evaluation/evaluate_pipeline_against_gold.py` |
| Script | `scripts/evaluation/evaluate_neural_vs_neurosymbolic.py` |
| Output | `outputs/metrics/gold_ud_vs_gold_karaka_eval.csv` |
| Output | `outputs/metrics/stanza_vs_gold_karaka_eval.csv` |
| Output | `outputs/metrics/karaka_confusion_matrix_stanza.csv` |
| Output | `outputs/metrics/neural_only_eval.csv` |
| Output | `outputs/metrics/neurosymbolic_eval.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/evaluation/evaluate_dev_metrics_strict_vs_candidate.py` |
| Output | `outputs/metrics/dev_metrics_strict_vs_candidate.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/analysis/analyze_dev_neural_errors.py` |
| Output | `outputs/error_analysis/dev_neural_only_errors.csv` |
| Output | `outputs/error_analysis/dev_neural_error_summary.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/analysis/analyze_dev_actionable_errors.py` |
| Script | `scripts/analysis/inspect_top_actionable_error_examples.py` |
| Output | `outputs/error_analysis/dev_actionable_neural_errors.csv` |
| Output | `outputs/error_analysis/dev_actionable_error_summary.csv` |
| Output | `outputs/error_analysis/top_actionable_error_examples.csv` |
...
| Doc | `docs/final/correction_layer_log.md` |
...
- Applied via split-aware `scripts/evaluation/apply_correction_v2.py` (and split-specific dev/train scripts).
...
|------|------|
| Code | `src/pipeline/correction_layer_v2.py` |
| Script | `scripts/evaluation/apply_correction_v2.py` |
| Script | `scripts/legacy/apply_correction_v2_dev.py` |
| Script | `scripts/legacy/apply_correction_v2_train.py` |
| Output | `experiments/stanza/corrected/stanza_dev_corrected_v2_all.csv` |
| Output | `experiments/stanza/corrected/stanza_train_corrected_v2_all.csv` |
| Output | `experiments/stanza/corrected/stanza_test_corrected_v2_all.csv` |
...
| Type | Path |
|------|------|
| Script | `scripts/evaluation/evaluate_correction_v2.py` |
| Script | `scripts/legacy/evaluate_correction_v2_dev.py` |
| Script | `scripts/legacy/evaluate_correction_v2_train.py` |
| Script | `scripts/evaluation/compare_correction_v2_per_karaka.py` |
| Doc | `docs/final/final_train_dev_results.md` |
| Output | `outputs/metrics/dev_correction_v2_metrics.csv` |
| Output | `outputs/metrics/train_correction_v2_metrics.csv` |
| Output | `outputs/metrics/dev_correction_v2_per_karaka_comparison.csv` |
...
- Manual review of 50 examples per flag in `docs/experiments/passive_example_manual_summary.md`.

**Important files:**

| Type | Path |
|------|------|
| Script | `scripts/analysis/analyze_passive_diagnostics.py` |
| Doc | `docs/experiments/passive_example_manual_summary.md` |
| Output | `outputs/error_analysis/passive_diagnostic_summary.csv` |
| Output | `outputs/error_analysis/passive_diagnostic_examples.csv` |
...
| Script | `scripts/experiments/apply_dependency_repair_v1_dev.py` |
| Script | `scripts/experiments/evaluate_dependency_repair_v1_dev.py` |
| Output | `outputs/rejected_experiments/dependency_repair_v1/dependency_repair_v1_dev_eval.csv` |
| Output | `outputs/rejected_experiments/dependency_repair_v1/dependency_repair_v1_dev_dr1_cases.csv` |
| Output | `experiments/rejected/dependency_repair_v1/stanza_dev_dependency_repaired_v1_all.csv` |
...
| `docs/archive/project_status_checkpoint_3.md` |
| `docs/final/correction_layer_log.md` |
| `docs/final/final_train_dev_results.md` |
| `docs/paper/paper_assets/` |
...
| Script | `scripts/evaluation/evaluate_correction_v2.py` |
| Script | `scripts/evaluation/compare_correction_v2_per_karaka.py` |
| Doc | `docs/final/final_test_results.md` |
| Output | `outputs/metrics/test_correction_v2_metrics.csv` |
| Output | `outputs/metrics/test_correction_v2_per_karaka_comparison.csv` |
| Output | `experiments/stanza/baseline/stanza_test_baseline_all.csv` |
| Output | `experiments/stanza/corrected/stanza_test_corrected_v2_all.csv` |
...
## Post-Freeze Validation and Analysis

**Objective:** After the Stanza test freeze, extend the repository for maintainability, cross-parser robustness validation, and publication-ready error analysis — **without changing the frozen symbolic system**.

### Repository reorganization

- Moved `output/` → `outputs/`, `results/` → `experiments/stanza/`, reorganized `scripts/` and `docs/`.
- Added `src/paths.py` and `scripts/_bootstrap.py`.
- Documented in `MIGRATION_LOG.md`. Stanza artifacts moved, not regenerated.

### UDPipe robustness experiment

- Added `src/parser/udpipe_parser.py`, `src/pipeline/run_udpipe_baseline.py`, and UDPipe path helpers.
- Extended evaluation scripts with `--parser {stanza,udpipe}`; **no symbolic rule changes**.
- Dev/test UDPipe metrics in `outputs/metrics/udpipe_*_correction_v2_metrics.csv`.
- **Finding:** Token matching identical to Stanza (99.63%); Adhikarana strict F1 nearly unchanged on test (0.8237 vs 0.8233); overall UDPipe strict accuracy lower (0.5646 vs 0.5980). H1 fires on both parsers (test: 130 Stanza, 137 UDPipe).

### Final error analysis

- Script: `scripts/analysis/analyze_final_error_patterns.py`
- Outputs: `outputs/error_analysis/{parser}_{split}_*.csv`
- Paper table: `outputs/error_analysis/paper_error_analysis_table_v2.md`
- Failure taxonomy and sanity check documented in `docs/final/project_update_after_freeze.md`.

**Full post-freeze chronology:** `docs/final/project_update_after_freeze.md`, `docs/final/project_timeline.md`.
...
- Gold labels: `outputs/gold/gold_karaka_labels.csv`
