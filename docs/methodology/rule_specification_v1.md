...
**Inputs:** UD dependency parse + conservative mapping from `docs/methodology/ud_to_karaka_mapping_v1.md`  
**Evidence base:** `notebooks/exploration/02_postposition_analysis.ipynb`, `docs/methodology/project_context.md`
...
- Mapping hypothesis: `docs/methodology/ud_to_karaka_mapping_v1.md`
- Postposition evidence: `notebooks/exploration/02_postposition_analysis.ipynb`
