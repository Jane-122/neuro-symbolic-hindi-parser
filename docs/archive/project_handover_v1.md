...
**Status note:** This is a historical handover. The current finalized framing is **Neuro-Symbolic Karaka Extraction for Hindi from Neural Dependency Parses**, not direct improvement of UD dependency parsing. For the current state, use `docs/archive/project_status_checkpoint_3.md`, `docs/final/correction_layer_log.md`, and `docs/methodology/project_context.md`.
...
**Primary authority:** `docs/methodology/project_context.md`
...
- Applies rules R1 to R5 from `docs/methodology/rule_specification_v1.md`.
...
**Outputs:** Statistical basis for R1 to R5 in `docs/methodology/rule_specification_v1.md`.
...
**Outputs:** Working verifier module; `experiments/stanza/gold_ud/run_on_sentence_output.txt`.
...
Rules are implemented in `src/verifier/simple_verifier.py` and documented in `docs/methodology/rule_specification_v1.md`.
...
**File:** `src/mapper/simple_mapper.py`  
**Reference:** `docs/methodology/ud_to_karaka_mapping_v1.md`
...
- Output: `experiments/stanza/gold_ud/test_baseline_all.csv`, `experiments/stanza/gold_ud/test_baseline_meaningful.csv`
...
2. `docs/archive/project_handover_v1.md` (this file)
...
8. `docs/experiments/verifier_v1_dev_baseline.md`
