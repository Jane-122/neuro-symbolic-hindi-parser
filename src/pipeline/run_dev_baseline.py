"""
Run Pipeline v1 on the full Hindi-HDTB dev split and save baseline CSV outputs.
...
def print_dev_summary(rows, num_sentences):
    """Print baseline statistics for the dev split."""
    ...
    print("Dev baseline summary (Pipeline v1)")
    print("-" * 40)
...
def main():
    ...
    print()
    print_dev_summary(all_rows, len(sentences))
